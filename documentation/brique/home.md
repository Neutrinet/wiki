# Documentation Brique/Yunohost

- [Installer une brique Olimex](install)
- [Installer Yunohost et le VPN Neutrinet sur un serveur X86](install-x86)
- [DNS Config for your Cube](dns)
